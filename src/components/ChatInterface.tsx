...
const ChatInterface = ({ 
  ...
  const isLoading = externalMessages ? externalIsLoading : internalIsLoading;
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    if (onSendMessage) {
      ...
      // Don't set loading to false here - let the parent handle the response
      return; // Don't add to internal messages when using external messages
    }

    // Only add to internal messages if not using external messages
